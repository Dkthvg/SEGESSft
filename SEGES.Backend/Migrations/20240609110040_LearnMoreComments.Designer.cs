...
namespace SEGES.Backend.Migrations
{
    ...
    [Migration("20240609110040_LearnMoreComments")]
    partial class LearnMoreComments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SEGES.Shared.Entities.LearnMoreComments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SEGES.Shared.Entities.UserApp", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SEGES.Shared.Entities.UserApp", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SEGES.Shared.Entities.Project", b =>
                {
                    b.HasOne("SEGES.Shared.Entities.UserApp", "ProjectManager")
                        .WithMany()
                    ...
                    b.HasOne("SEGES.Shared.Entities.UserApp", "RequirementsEngineer")
                        .WithMany()
                        .HasForeignKey("RequirementsEngineer_ID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SEGES.Shared.Entities.UserApp", "StakeHolder")
                        .WithMany()
